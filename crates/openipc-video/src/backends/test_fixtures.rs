// Tiny 128x128 random-access frames generated locally by VideoToolbox. They
// contain the parameter sets required to initialize a fresh decoder.
pub(crate) const H264_KEYFRAME: &[u8] = &[
...
pub(crate) const H265_KEYFRAME: &[u8] = &[
