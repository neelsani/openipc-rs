...
use crate::types::{ChannelWidth, ChipFamily, ChipInfo, DriverError, MonitorOptions};
...
impl RealtekDevice {
    ...
    pub async fn run_iqk_async(
        ...
        match chip.family {
            ...
            ChipFamily::Rtl8821c => {
                self.run_iqk_8821c_async(chip, channel <= 14).await?;
                Ok(IqkReport {
                    chip,
                    channel,
                    ran: true,
            ...
            ChipFamily::Rtl8822e => {
                self.run_iqk_8822e_async(
                    ...
                    ChannelWidth::Mhz20,
                    channel,
                    MonitorOptions::from_env().skip_txgapk,
                )
                .await
            }
